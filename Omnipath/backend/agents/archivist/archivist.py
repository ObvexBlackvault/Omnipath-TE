...
class Archivist:
    def __init__(self, name="archivist_soul_001"):
        self.name = name
    ...
    def load_checklist(self):
        try:
            ...
            print(f"Archivist checklist load error: {e}")
        self.checklist = {}
    ...
    def shutdown(self, signum, frame):
        self.logger.info("Archivist shutting down.")
        exit(0)

if __name__ == "__main__":
    archivist = Archivist()
    archivist.emit_event("heartbeat", "Archivist online.")
